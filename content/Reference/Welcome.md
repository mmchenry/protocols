The knowledge base uses **sibling folders** under `content/`—for example **Reference** (how-tos, onboarding) and **McHenry Lab Protocols** (operational SOPs). Nest topic folders inside each area as needed.
