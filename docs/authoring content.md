...
You can edit and maintain your Quartz content with any tool you like: **VS Code**, **Cursor**, **GitHub’s web editor**, **[Obsidian](https://obsidian.md/)**, or another Markdown editor. Obsidian is optional but provides a vault-style UI, previews, and wikilink affordances; the same files work from any editor.
